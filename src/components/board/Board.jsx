...
const Board = () => {
    ...
    const playerKing8Star = (index) => {
        ...
        for (let i = 0; i < 8; i++) {
            combThroughSubArrayPlus(index, rookMoves[i], arr[0], playerSquaresRender, enemySquaresRender, true)
            combThroughSubArrayMinus(index, rookMoves[i], arr[1], playerSquaresRender, enemySquaresRender, true)
        }

        for (let i = 8; i < 16; i++) {
            combThroughSubArrayPlus(index, rookMoves[i], arr[2], playerSquaresRender, enemySquaresRender, true)
            combThroughSubArrayMinus(index, rookMoves[i], arr[3], playerSquaresRender, enemySquaresRender, true)
        }
    ...
    const enemyKing8Star = (index) => {
        ...
        for (let i = 0; i < 8; i++) {
            combThroughSubArrayPlus(index, rookMoves[i], arr[0], enemySquaresRender, playerSquaresRender)
            combThroughSubArrayMinus(index, rookMoves[i], arr[1], enemySquaresRender, playerSquaresRender)
        }

        for (let i = 8; i < 16; i++) {
            combThroughSubArrayPlus(index, rookMoves[i], arr[2], enemySquaresRender, playerSquaresRender)
            combThroughSubArrayMinus(index, rookMoves[i], arr[3], enemySquaresRender, playerSquaresRender)
        }
    ...
    const playerKing8StarXray = (index) => {
        ...
        for (let i = 0; i < 8; i++) {
            combThroughSubArrayPlus(index, rookMoves[i], arr[0], playerSquaresRender, enemySquaresRender, false)
            combThroughSubArrayMinus(index, rookMoves[i], arr[1], playerSquaresRender, enemySquaresRender, false)
        }

        for (let i = 8; i < 16; i++) {
            combThroughSubArrayPlus(index, rookMoves[i], arr[2], playerSquaresRender, enemySquaresRender, false)
            combThroughSubArrayMinus(index, rookMoves[i], arr[3], playerSquaresRender, enemySquaresRender, false)
        }
    ...
    const enemyKing8StarXray = (index) => {
        ...
        for (let i = 0; i < 8; i++) {
            combThroughSubArrayPlus(index, rookMoves[i], arr[0], enemySquaresRender, playerSquaresRender, false)
            combThroughSubArrayMinus(index, rookMoves[i], arr[1], enemySquaresRender, playerSquaresRender, false)
        }

        for (let i = 8; i < 16; i++) {
            combThroughSubArrayPlus(index, rookMoves[i], arr[2], enemySquaresRender, playerSquaresRender, false)
            combThroughSubArrayMinus(index, rookMoves[i], arr[3], enemySquaresRender, playerSquaresRender, false)
        }
    ...
    const renderBoard = () => {
        ...
        return (
            <div className="board">
                {arr1.map((a, i) => <div key={i + 1 * 300} className={`${i % 2 === 0 ? "white" : "black"} ${i + 1 === pieceSquare ? "highlight" : null}`}>
                    ...
                    {coordinates && i + 1 === 8 && color === "white" ? <div className="numbers">8</div> : null}
                    {coordinates && i + 1 === 8 && color === "black" ? <div className="numbers">1</div> : null}
                </div>)}

                {arr2.map((a, i) => <div key={i + 9 * 300} className={`${i % 2 !== 0 ? "white" : "black"} ${i + 9 === pieceSquare ? "highlight" : null}`}>
                    ...
                    {coordinates && i + 9 === 16 && color === "white" ? <div className="numbers">7</div> : null}
                    {coordinates && i + 9 === 16 && color === "black" ? <div className="numbers">2</div> : null}
                </div>)}

                {arr3.map((a, i) => <div key={i + 17 * 300} className={`${i % 2 === 0 ? "white" : "black"} ${i + 17 === pieceSquare ? "highlight" : null}`}>
                    ...
                    {coordinates && i + 17 === 24 && color === "white" ? <div className="numbers">6</div> : null}
                    {coordinates && i + 17 === 24 && color === "black" ? <div className="numbers">3</div> : null}
                </div>)}

                {arr4.map((a, i) => <div key={i + 25 * 300} className={`${i % 2 !== 0 ? "white" : "black"} ${i + 25 === pieceSquare ? "highlight" : null}`}>
                    ...
                    {coordinates && i + 25 === 32 && color === "white" ? <div className="numbers">5</div> : null}
                    {coordinates && i + 25 === 32 && color === "black" ? <div className="numbers">4</div> : null}
                </div>)}

                {arr5.map((a, i) => <div key={i + 33 * 300} className={`${i % 2 === 0 ? "white" : "black"} ${i + 33 === pieceSquare ? "highlight" : null}`}>
                    ...
                    {coordinates && i + 33 === 40 && color === "white" ? <div className="numbers">4</div> : null}
                    {coordinates && i + 33 === 40 && color === "black" ? <div className="numbers">5</div> : null}
                </div>)}

                {arr6.map((a, i) => <div key={i + 41 * 300} className={`${i % 2 !== 0 ? "white" : "black"} ${i + 41 === pieceSquare ? "highlight" : null}`}>
                    ...
                    {coordinates && i + 41 === 48 && color === "white" ? <div className="numbers">3</div> : null}
                    {coordinates && i + 41 === 48 && color === "black" ? <div className="numbers">6</div> : null}
                </div>)}

                {arr7.map((a, i) => <div key={i + 49 * 300} className={`${i % 2 === 0 ? "white" : "black"} ${i + 49 === pieceSquare ? "highlight" : null}`}>
                    ...
                    {coordinates && i + 49 === 56 && color === "white" ? <div className="numbers">2</div> : null}
                    {coordinates && i + 49 === 56 && color === "black" ? <div className="numbers">7</div> : null}
                </div>)}

                {arr8.map((a, i) => <div key={i + 57 * 300} className={`${i % 2 !== 0 ? "white" : "black"} ${i + 57 === pieceSquare ? "highlight" : null}`} >
                    ...
                    {coordinates && color === "white" ? <div className="letters">{letters[i]}</div> : null}
                    {coordinates && color === "black" ? <div className="letters">{letters[7 - i]}</div> : null}
                    {coordinates && i + 57 === 64 && color === "white" ? <div className="numbers">1</div> : null}
                    {coordinates && i + 57 === 64 && color === "black" ? <div className="numbers">8</div> : null}
                </div>)}
            </div>
        )
    }
