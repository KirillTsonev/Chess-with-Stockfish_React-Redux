...
const Board = () => {
    ...
    const renderBoard = () => {
        ...
        return (
            <div className="board">
                {letters.map((a, i) => <div key={i + 1 * 300} className={`${i % 2 === 0 ? "white" : "black"} ${i + 1 === pieceSquare ? "highlight" : null}`}>
                    ...
                    {coordinates && color === "black" && !sandbox ? <div className="reverseLetters">{letters[i]}</div> : null}
                    {coordinates && i + 1 === 8 && color === "white" ? <div className="numbers">8</div> : null}
                    {coordinates && i + 1 === 8 && color === "black" && sandbox ? <div className="numbers">1</div> : null}
                    {coordinates && i === 0 && color === "black" && !sandbox ? <div className="reverseNumbers">8</div> : null}
                </div>)}

                {letters.map((a, i) => <div key={i + 9 * 300} className={`${i % 2 !== 0 ? "white" : "black"} ${i + 9 === pieceSquare ? "highlight" : null}`}>
                    ...
                    {coordinates && i + 9 === 16 && color === "black" && sandbox ? <div className="numbers">2</div> : null}
                    {coordinates && i === 0 && color === "black" && !sandbox ? <div className="reverseNumbers">7</div> : null}
                </div>)}

                {letters.map((a, i) => <div key={i + 17 * 300} className={`${i % 2 === 0 ? "white" : "black"} ${i + 17 === pieceSquare ? "highlight" : null}`}>
                    ...
                    {coordinates && i + 17 === 24 && color === "black" && sandbox ? <div className="numbers">3</div> : null}
                    {coordinates && i === 0 && color === "black" && !sandbox ? <div className="reverseNumbers">6</div> : null}
                </div>)}

                {letters.map((a, i) => <div key={i + 25 * 300} className={`${i % 2 !== 0 ? "white" : "black"} ${i + 25 === pieceSquare ? "highlight" : null}`}>
                    ...
                    {coordinates && i + 25 === 32 && color === "black" && sandbox ? <div className="numbers">4</div> : null}
                    {coordinates && i === 0 && color === "black" && !sandbox ? <div className="reverseNumbers">5</div> : null}
                </div>)}

                {letters.map((a, i) => <div key={i + 33 * 300} className={`${i % 2 === 0 ? "white" : "black"} ${i + 33 === pieceSquare ? "highlight" : null}`}>
                    ...
                    {coordinates && i + 33 === 40 && color === "black" && sandbox ? <div className="numbers">5</div> : null}
                    {coordinates && i === 0 && color === "black" && !sandbox ? <div className="reverseNumbers">4</div> : null}
                </div>)}

                {letters.map((a, i) => <div key={i + 41 * 300} className={`${i % 2 !== 0 ? "white" : "black"} ${i + 41 === pieceSquare ? "highlight" : null}`}>
                    ...
                    {coordinates && i + 41 === 48 && color === "black" && sandbox ? <div className="numbers">6</div> : null}
                    {coordinates && i === 0 && color === "black" && !sandbox ? <div className="reverseNumbers">3</div> : null}
                </div>)}

                {letters.map((a, i) => <div key={i + 49 * 300} className={`${i % 2 === 0 ? "white" : "black"} ${i + 49 === pieceSquare ? "highlight" : null}`}>
                    ...
                    {coordinates && i + 49 === 56 && color === "black" && sandbox ? <div className="numbers">7</div> : null}
                    {coordinates && i === 0 && color === "black" && !sandbox ? <div className="reverseNumbers">2</div> : null}
                </div>)}

                {letters.map((a, i) => <div key={i + 57 * 300} className={`${i % 2 !== 0 ? "white" : "black"} ${i + 57 === pieceSquare ? "highlight" : null}`} >
                    ...
                    {coordinates && color === "black" && sandbox ? <div className="letters">{letters[7 - i]}</div> : null}
                    {coordinates && i + 57 === 64 && color === "white" ? <div className="numbers">1</div> : null}
                    {coordinates && i + 57 === 64 && color === "black" && sandbox ? <div className="numbers">8</div> : null}
                    {coordinates && i === 0 && color === "black" && !sandbox ? <div className="reverseNumbers">1</div> : null}
                </div>)}
            </div>
        )
    }
